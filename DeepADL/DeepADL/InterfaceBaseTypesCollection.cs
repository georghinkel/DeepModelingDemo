...
namespace FZI.SoftwareEngineering.DeepModeling.DeepADL
{
    ...
    /// <summary>
    /// The collection class to implement the refined BaseTypes reference for the Interface class
    /// </summary>
    public class InterfaceBaseTypesCollection : ICollectionExpression<NMF.Models.Meta.IClass>, ICollection<NMF.Models.Meta.IClass>
    {
        ...
        /// </summary>
        public InterfaceBaseTypesCollection(IInterface parent)
        {
            this._parent = parent;
        }
        ...
        {
            if (InterfaceBaseTypesCollection._standardValues.Contains(item))
            {
                return true;
            }
            return false;
        ...
        {
            InterfaceBaseTypesCollection._standardValues.CopyTo(array, arrayIndex);
        ...
        {
            return InterfaceBaseTypesCollection._standardValues.Cast<NMF.Models.Meta.IClass>().GetEnumerator();
        }
