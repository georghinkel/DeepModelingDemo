...
namespace FZI.SoftwareEngineering.DeepModeling.DeepADL
{
    ...
    /// </summary>
    public class InterfaceBaseTypesCollection : ICollectionExpression<IClass>, ICollection<IClass>, INotifyCollection<IClass>
    {
        ...
        {
            return InterfaceBaseTypesCollection._standardValues.Cast<IClass>().GetEnumerator();
        }
