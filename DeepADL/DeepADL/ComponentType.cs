...
namespace FZI.SoftwareEngineering.DeepModeling.DeepADL
{
    ...
    public partial class ComponentType : NMF.Models.Meta.MetaElement, IComponentType, NMF.Models.IModelElement
    {
        ...
        event EventHandler<ValueChangedEventArgs> IType.NamespaceChanging
        {
            ...
            {
                IComponentType _this_ComponentType = this;
                _this_ComponentType.RepositoryChanging += value;
            }
            remove
            {
                IComponentType _this_ComponentType = this;
        ...
        {
            return ((NMF.Models.Meta.ITypedElement)(((NMF.Models.ModelElement)(FZI.SoftwareEngineering.DeepModeling.DeepADL.ComponentType.ClassInstance)).Resolve("RequiredInterfaces")));
        }
        ...
        {
            return ((NMF.Models.Meta.ITypedElement)(((NMF.Models.ModelElement)(FZI.SoftwareEngineering.DeepModeling.DeepADL.ComponentType.ClassInstance)).Resolve("ProvidedInterfaces")));
        }
        ...
        {
            return ((NMF.Models.Meta.ITypedElement)(((NMF.Models.ModelElement)(FZI.SoftwareEngineering.DeepModeling.DeepADL.ComponentType.ClassInstance)).Resolve("Services")));
        }
        ...
        {
            return ((NMF.Models.Meta.ITypedElement)(((NMF.Models.ModelElement)(FZI.SoftwareEngineering.DeepModeling.DeepADL.ComponentType.ClassInstance)).Resolve("Repository")));
        }
