...
namespace FZI.SoftwareEngineering.DeepModeling.DeepADL
{
    ...
    /// </summary>
    public class ComponentTypeReferencesCollection : ICollectionExpression<NMF.Models.Meta.IReference>, ICollection<NMF.Models.Meta.IReference>
    {
        ...
        {
            IEnumerator<NMF.Models.Meta.IReference> requiredInterfacesEnumerator = this._parent.RequiredInterfaces.GetEnumerator();
            try
            {
                for (
        ...
        {
            return Enumerable.Empty<NMF.Models.Meta.IReference>().Concat(this._parent.RequiredInterfaces).GetEnumerator();
        }
        ...
        /// </summary>
        public virtual INotifyCollection<NMF.Models.Meta.IReference> AsNotifiable()
        {
