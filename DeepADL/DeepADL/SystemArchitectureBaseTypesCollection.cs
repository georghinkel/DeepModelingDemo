...
namespace FZI.SoftwareEngineering.DeepModeling.DeepADL
{
    ...
    /// <summary>
    /// The collection class to implement the refined BaseTypes reference for the SystemArchitecture class
    /// </summary>
    public class SystemArchitectureBaseTypesCollection : ICollectionExpression<NMF.Models.Meta.IClass>, ICollection<NMF.Models.Meta.IClass>
    {
        
        private ISystemArchitecture _parent;
        
        private static NMF.Models.Meta.IClass[] _standardValues = new NMF.Models.Meta.IClass[] {
                ((NMF.Models.Meta.IClass)(NMF.Models.Repository.MetaRepository.Instance.Resolve("http://github.com/georghinkel/DeepADL/1.0#//SystemAllocation")))};
        ...
        {
            if (SystemArchitectureBaseTypesCollection._standardValues.Contains(item))
            {
                return true;
            }
            return false;
        ...
        {
            SystemArchitectureBaseTypesCollection._standardValues.CopyTo(array, arrayIndex);
        ...
        {
            return SystemArchitectureBaseTypesCollection._standardValues.Cast<NMF.Models.Meta.IClass>().GetEnumerator();
        }
