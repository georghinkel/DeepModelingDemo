...
namespace FZI.SoftwareEngineering.DeepModeling.DeepADL
{
    ...
    /// </summary>
    public class SystemArchitectureBaseTypesCollection : ICollectionExpression<IClass>, ICollection<IClass>, INotifyCollection<IClass>
    {
        
        private ISystemArchitecture _parent;
        
        private static IClass[] _standardValues = new IClass[] {
                ((IClass)(NMF.Models.Repository.MetaRepository.Instance.Resolve("http://github.com/georghinkel/DeepADL/1.0#//SystemAllocation/")))};
        ...
        {
            return SystemArchitectureBaseTypesCollection._standardValues.Cast<IClass>().GetEnumerator();
        }
