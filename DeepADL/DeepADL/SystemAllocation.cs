...
namespace FZI.SoftwareEngineering.DeepModeling.DeepADL
{
    ...
    public abstract class SystemAllocation : ModelElement, ISystemAllocation, IModelElement
    {
        ...
        public virtual IResourceEnvironment Environment
        {
            ...
            set
            {
                if ((this._environment != value))
                {
                    ...
                    this.OnEnvironmentChanged(new ValueChangedEventArgs(old, value));
                }
            }
        }
        ...
        public new static NMF.Models.Meta.IClass ClassInstance
        {
            get
            {
                return NMF.Models.Repository.MetaRepository.Instance.ResolveClass("http://github.com/georghinkel/DeepADL/1.0#//SystemAllocation/");
            }
        }
        ...
        {
            return ((IClass)(NMF.Models.Repository.MetaRepository.Instance.Resolve("http://github.com/georghinkel/DeepADL/1.0#//SystemAllocation/")));
        }
        
        /// <summary>
        /// The collection class to to represent the children of the SystemAllocation class
        /// </summary>
        public class SystemAllocationReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
