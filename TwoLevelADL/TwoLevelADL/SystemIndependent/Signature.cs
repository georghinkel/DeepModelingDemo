...
namespace FZI.SoftwareEngineering.DeepModeling.TwoLevelADL.SystemIndependent
{
    ...
    [ModelRepresentationClassAttribute("http://github.com/georghinkel/TwoLevelADL/1.0#//SystemIndependent/Signature")]
    ...
    public partial class Signature : NamedElement, ISignature, IModelElement
    {
        ...
        public Nullable<Type> ReturnType
        {
            get
            {
        ...
        [ConstantAttribute()]
        public IOrderedSetExpression<IParameter> Parameter
        {
            get
            {
        ...
        public new static IClass ClassInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((IClass)(MetaRepository.Instance.Resolve("http://github.com/georghinkel/TwoLevelADL/1.0#//SystemIndependent/Signature")));
                }
        ...
        {
            return ((ITypedElement)(((ModelElement)(FZI.SoftwareEngineering.DeepModeling.TwoLevelADL.SystemIndependent.Signature.ClassInstance)).Resolve("ReturnType")));
        }
        ...
        {
            return ((ITypedElement)(((ModelElement)(FZI.SoftwareEngineering.DeepModeling.TwoLevelADL.SystemIndependent.Signature.ClassInstance)).Resolve("Parameter")));
        }
        ...
        private void ParameterCollectionChanging(object sender, NotifyCollectionChangingEventArgs e)
        {
