...
namespace FZI.SoftwareEngineering.DeepModeling.TwoLevelADL.SystemIndependent
{
    ...
    public interface IComponent : IModelElement, INamedElement
    {
        ...
        /// </summary>
        IOrderedSetExpression<IInterface> ProvidedInterfaces
        {
            get;
        }
        ...
        /// </summary>
        IOrderedSetExpression<IInterface> RequiredInterfaces
        {
            get;
        }
    }
