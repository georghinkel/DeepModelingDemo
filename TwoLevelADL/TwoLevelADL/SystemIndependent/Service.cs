...
namespace FZI.SoftwareEngineering.DeepModeling.TwoLevelADL.SystemIndependent
{
    ...
    [ModelRepresentationClassAttribute("http://github.com/georghinkel/TwoLevelADL/1.0#//SystemIndependent/Service")]
    public partial class Service : ModelElement, IService, IModelElement
    {
        ...
        public new static IClass ClassInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((IClass)(MetaRepository.Instance.Resolve("http://github.com/georghinkel/TwoLevelADL/1.0#//SystemIndependent/Service")));
                }
        ...
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> SignatureChanging;
        
        /// <summary>
        /// Gets fired when the Signature property changed its value
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> SignatureChanged;
        
        private static ITypedElement RetrieveSignatureReference()
        {
            return ((ITypedElement)(((ModelElement)(FZI.SoftwareEngineering.DeepModeling.TwoLevelADL.SystemIndependent.Service.ClassInstance)).Resolve("Signature")));
        }
        ...
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.SignatureChanging;
            if ((handler != null))
            {
        ...
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.SignatureChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
