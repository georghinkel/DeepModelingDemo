...
namespace FZI.SoftwareEngineering.DeepModeling.TwoLevelADL.Deployment
{
    ...
    [ModelRepresentationClassAttribute("http://github.com/georghinkel/TwoLevelADL/1.0#//Deployment/Link")]
    ...
    public partial class Link : NamedElement, ILink, IModelElement
    {
        ...
        [ConstantAttribute()]
        public IOrderedSetExpression<FZI.SoftwareEngineering.DeepModeling.TwoLevelADL.Deployment.IContainer> ConnectedContainers
        {
            get
            {
        ...
        public new static IClass ClassInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((IClass)(MetaRepository.Instance.Resolve("http://github.com/georghinkel/TwoLevelADL/1.0#//Deployment/Link")));
                }
        ...
        {
            return ((ITypedElement)(((ModelElement)(FZI.SoftwareEngineering.DeepModeling.TwoLevelADL.Deployment.Link.ClassInstance)).Resolve("ConnectedContainers")));
        }
        ...
        private void ConnectedContainersCollectionChanging(object sender, NotifyCollectionChangingEventArgs e)
        {
        ...
        /// <param name="sender">The collection that raised the change</param>
        /// <param name="e">The original event data</param>
        private void ConnectedContainersCollectionChanged(object sender, NotifyCollectionChangedEventArgs e)
        {
        ...
        public class LinkReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            {
                FZI.SoftwareEngineering.DeepModeling.TwoLevelADL.Deployment.IContainer connectedContainersCasted = item.As<FZI.SoftwareEngineering.DeepModeling.TwoLevelADL.Deployment.IContainer>();
            ...
            public override bool Remove(IModelElement item)
            {
                ...
                if (((containerItem != null) 
                            && this._parent.ConnectedContainers.Remove(containerItem)))
                {
                    return true;
                }
                return false;
