...
namespace FZI.SoftwareEngineering.DeepModeling.Repository
{
    ...
    public class WebBrowser : MetaElement, IWebBrowser, IModelElement
    {
        ...
        public virtual IHTTP Backend
        {
            ...
            set
            {
                if ((this._backend != value))
                {
                    ...
                    this.OnPropertyChanged("Backend");
                    this.OnBackendChanged(new ValueChangedEventArgs(old, value));
                }
            }
        }
        ...
        public new static NMF.Models.Meta.IClass ClassInstance
        {
            get
            {
                return NMF.Models.Repository.MetaRepository.Instance.ResolveClass("http://github.com/georghinkel/mediaStore/Repository#//WebBrowser/");
            }
        }
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> BackendChanged;
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.BackendChanged;
            if ((handler != null))
            {
        ...
        private void OnResetBackend(object sender, EventArgs eventArgs)
        {
            this.Backend = null;
        }
        ...
        {
            return ((IComponentType)(NMF.Models.Repository.MetaRepository.Instance.Resolve("http://github.com/georghinkel/mediaStore/Repository#//WebBrowser/")));
        }
        ...
        {
            return ((IClass)(NMF.Models.Repository.MetaRepository.Instance.Resolve("http://github.com/georghinkel/mediaStore/Repository#//WebBrowser/")));
        }
        
        /// <summary>
        /// The collection class to to represent the children of the WebBrowser class
        /// </summary>
        public class WebBrowserReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            {
                return Enumerable.Empty<IModelElement>().Concat(this._parent.Backend).Concat(this._parent.DeclaringType).Concat(this._parent.Opposite).GetEnumerator();
            }
        }
        ...
        private sealed class BackendProxy : ModelPropertyChange<IWebBrowser, IHTTP>
        {
            ...
            {
                this.ModelElement.BackendChanged += handler;
            }
