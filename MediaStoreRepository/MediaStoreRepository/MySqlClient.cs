...
namespace FZI.SoftwareEngineering.DeepModeling.Repository
{
    ...
    public partial class MySqlClient : NMF.Models.Meta.MetaElement, IMySqlClient, NMF.Models.IModelElement
    {
        ...
        public override IEnumerableExpression<NMF.Models.IModelElement> Children
        {
            get
            {
                return base.Children.Concat(new MySqlClientChildrenCollection(this));
            }
        }
        ...
        public new static IComponentType ComponentTypeInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((NMF.Models.Meta.IClass)(MetaRepository.Instance.Resolve("http://github.com/georghinkel/mediaStore/Repository#//MySqlClient")));
                }
        ...
        /// <summary>
        /// The collection class to to represent the children of the MySqlClient class
        /// </summary>
        public class MySqlClientChildrenCollection : ReferenceCollection, ICollectionExpression<NMF.Models.IModelElement>, ICollection<NMF.Models.IModelElement>
        {
            
            private MySqlClient _parent;
            
            /// <summary>
            /// Creates a new instance
            /// </summary>
            public MySqlClientChildrenCollection(MySqlClient parent)
            {
                this._parent = parent;
            }
