...
namespace FZI.SoftwareEngineering.DeepModeling.Repository
{
    ...
    /// <summary>
    /// The default implementation of the DBAdapter class
    /// </summary>
    [XmlNamespaceAttribute("http://github.com/georghinkel/mediaStore/Repository")]
    [XmlNamespacePrefixAttribute("repo")]
    [ModelRepresentationClassAttribute("http://github.com/georghinkel/mediaStore/Repository#//DBAdapter")]
    [DebuggerDisplayAttribute("DBAdapter {Name}")]
    public partial class DBAdapter : NMF.Models.Meta.MetaElement, IDBAdapter, NMF.Models.IModelElement
    {
        
        private static Lazy<NMF.Models.Meta.ITypedElement> _commandReference = new Lazy<NMF.Models.Meta.ITypedElement>(RetrieveCommandReference);
        
        /// <summary>
        /// The backing field for the Command property
        /// </summary>
        private ICommandInterface _command;
        ...
        /// </summary>
        private IConnectionInterface _connection;
        
        private static Lazy<NMF.Models.Meta.ITypedElement> _dataReaderReference = new Lazy<NMF.Models.Meta.ITypedElement>(RetrieveDataReaderReference);
        
        /// <summary>
        /// The backing field for the DataReader property
        /// </summary>
        private IDataReaderInterface _dataReader;
        ...
        public ICommandInterface Command
        {
            get
            {
            ...
            set
            {
                ...
                {
                    ICommandInterface old = this._command;
        ...
        [XmlAttributeAttribute(true)]
        public IConnectionInterface Connection
        {
            get
            {
            ...
            set
            {
                ...
                {
                    IConnectionInterface old = this._connection;
                    ValueChangedEventArgs e = new ValueChangedEventArgs(old, value);
                    this.OnConnectionChanging(e);
                    this.OnPropertyChanging("Connection", e, _connectionReference);
                    this._connection = value;
                    if ((old != null))
                    {
                        old.Deleted -= this.OnResetConnection;
                    }
                    if ((value != null))
                    {
                        value.Deleted += this.OnResetConnection;
                    }
                    this.OnConnectionChanged(e);
                    this.OnPropertyChanged("Connection", e, _connectionReference);
                }
            }
        }
        ...
        [XmlAttributeAttribute(true)]
        public IDataReaderInterface DataReader
        {
            get
            {
            ...
            set
            {
                if ((this._dataReader != value))
                {
                    IDataReaderInterface old = this._dataReader;
                    ValueChangedEventArgs e = new ValueChangedEventArgs(old, value);
                    this.OnDataReaderChanging(e);
                    this.OnPropertyChanging("DataReader", e, _dataReaderReference);
                    this._dataReader = value;
                    if ((old != null))
                    {
                        old.Deleted -= this.OnResetDataReader;
                    }
                    if ((value != null))
                    {
                        value.Deleted += this.OnResetDataReader;
                    }
                    this.OnDataReaderChanged(e);
                    this.OnPropertyChanged("DataReader", e, _dataReaderReference);
                }
            }
        }
        ...
        public override IEnumerableExpression<NMF.Models.IModelElement> Children
        {
            get
            {
                return base.Children.Concat(new DBAdapterChildrenCollection(this));
            }
        }
        ...
        public override IEnumerableExpression<NMF.Models.IModelElement> ReferencedElements
        {
            get
            {
                return base.ReferencedElements.Concat(new DBAdapterReferencedElementsCollection(this));
            }
        }
        ...
        public new static IComponentType ComponentTypeInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((NMF.Models.Meta.IClass)(MetaRepository.Instance.Resolve("http://github.com/georghinkel/mediaStore/Repository#//DBAdapter")));
                }
        ...
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> DataReaderChanging;
        
        /// <summary>
        /// Gets fired when the DataReader property changed its value
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> DataReaderChanged;
        ...
        private static NMF.Models.Meta.ITypedElement RetrieveCommandReference()
        {
            return ((NMF.Models.Meta.ITypedElement)(((NMF.Models.ModelElement)(FZI.SoftwareEngineering.DeepModeling.Repository.DBAdapter.ClassInstance)).Resolve("command")));
        }
        ...
        {
            return ((NMF.Models.Meta.ITypedElement)(((NMF.Models.ModelElement)(FZI.SoftwareEngineering.DeepModeling.Repository.DBAdapter.ClassInstance)).Resolve("connection")));
        }
        ...
        /// <summary>
        /// Handles the event that the Connection property must reset
        /// </summary>
        /// <param name="sender">The object that sent this reset request</param>
        /// <param name="eventArgs">The event data for the reset event</param>
        private void OnResetConnection(object sender, System.EventArgs eventArgs)
        {
            this.Connection = null;
        }
        
        private static NMF.Models.Meta.ITypedElement RetrieveDataReaderReference()
        {
            return ((NMF.Models.Meta.ITypedElement)(((NMF.Models.ModelElement)(FZI.SoftwareEngineering.DeepModeling.Repository.DBAdapter.ClassInstance)).Resolve("dataReader")));
        }
        
        /// <summary>
        /// Raises the DataReaderChanging event
        /// </summary>
        /// <param name="eventArgs">The event data</param>
        protected virtual void OnDataReaderChanging(ValueChangedEventArgs eventArgs)
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.DataReaderChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        /// <summary>
        /// Raises the DataReaderChanged event
        /// </summary>
        /// <param name="eventArgs">The event data</param>
        protected virtual void OnDataReaderChanged(ValueChangedEventArgs eventArgs)
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.DataReaderChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        /// <summary>
        /// Handles the event that the DataReader property must reset
        /// </summary>
        /// <param name="sender">The object that sent this reset request</param>
        /// <param name="eventArgs">The event data for the reset event</param>
        private void OnResetDataReader(object sender, System.EventArgs eventArgs)
        {
        ...
        protected override void SetFeature(string feature, object value)
        {
            if ((feature == "COMMAND"))
            {
                this.Command = ((ICommandInterface)(value));
                return;
            }
            if ((feature == "CONNECTION"))
            {
                this.Connection = ((IConnectionInterface)(value));
                return;
            }
            if ((feature == "DATAREADER"))
            {
                this.DataReader = ((IDataReaderInterface)(value));
                return;
            }
        ...
        protected override NMF.Expressions.INotifyExpression<object> GetExpressionForAttribute(string attribute)
        {
            ...
            if ((attribute == "DataReader"))
            {
                return new DataReaderProxy(this);
            }
        ...
        /// <summary>
        /// The collection class to to represent the children of the DBAdapter class
        /// </summary>
        public class DBAdapterChildrenCollection : ReferenceCollection, ICollectionExpression<NMF.Models.IModelElement>, ICollection<NMF.Models.IModelElement>
        {
            
            private DBAdapter _parent;
            
            /// <summary>
            /// Creates a new instance
            /// </summary>
            public DBAdapterChildrenCollection(DBAdapter parent)
            {
                this._parent = parent;
            }
        ...
        /// The collection class to to represent the children of the DBAdapter class
        /// </summary>
        public class DBAdapterReferencedElementsCollection : ReferenceCollection, ICollectionExpression<NMF.Models.IModelElement>, ICollection<NMF.Models.IModelElement>
        {
            ...
            /// Creates a new instance
            /// </summary>
            public DBAdapterReferencedElementsCollection(DBAdapter parent)
            {
                this._parent = parent;
            }
            ...
            public override int Count
            {
                get
                {
                    ...
                    if ((this._parent.Connection != null))
                    {
                        count = (count + 1);
                    }
                    if ((this._parent.DataReader != null))
                    {
                        count = (count + 1);
                    }
            ...
            protected override void AttachCore()
            {
                ...
                this._parent.ConnectionChanged += this.PropagateValueChanges;
                this._parent.DataReaderChanged += this.PropagateValueChanges;
            ...
            public override void Add(NMF.Models.IModelElement item)
            {
                if ((this._parent.Command == null))
                {
                    ICommandInterface commandCasted = item.As<ICommandInterface>();
                ...
                if ((this._parent.Connection == null))
                {
                    IConnectionInterface connectionCasted = item.As<IConnectionInterface>();
                    if ((connectionCasted != null))
                    {
                        this._parent.Connection = connectionCasted;
                        return;
                    }
                }
                if ((this._parent.DataReader == null))
                {
                    IDataReaderInterface dataReaderCasted = item.As<IDataReaderInterface>();
                    if ((dataReaderCasted != null))
                    {
                        this._parent.DataReader = dataReaderCasted;
                        return;
                    }
                }
                if ((this._parent.DeclaringType == null))
            ...
            public override void Clear()
            {
                ...
                this._parent.Connection = null;
                this._parent.DataReader = null;
            ...
            public override bool Contains(NMF.Models.IModelElement item)
            {
                ...
                if ((item == this._parent.Connection))
                {
                    return true;
                }
                if ((item == this._parent.DataReader))
                {
                    return true;
                }
            ...
            public override void CopyTo(NMF.Models.IModelElement[] array, int arrayIndex)
            {
                ...
                if ((this._parent.Connection != null))
                {
                    array[arrayIndex] = this._parent.Connection;
                    arrayIndex = (arrayIndex + 1);
                }
                if ((this._parent.DataReader != null))
                {
                    array[arrayIndex] = this._parent.DataReader;
                    arrayIndex = (arrayIndex + 1);
                }
                if ((this._parent.DeclaringType != null))
                {
            ...
            public override bool Remove(NMF.Models.IModelElement item)
            {
                ...
                if ((this._parent.Connection == item))
                {
                    this._parent.Connection = null;
                    return true;
                }
                if ((this._parent.DataReader == item))
                {
                    this._parent.DataReader = null;
                    return true;
                }
            ...
            public override IEnumerator<NMF.Models.IModelElement> GetEnumerator()
            {
                return Enumerable.Empty<NMF.Models.IModelElement>().Concat(this._parent.Command).Concat(this._parent.Connection).Concat(this._parent.DataReader).Concat(this._parent.DeclaringType).Concat(this._parent.Opposite).Concat(this._parent.Anchor).GetEnumerator();
            }
        }
        ...
        /// </summary>
        private sealed class CommandProxy : ModelPropertyChange<IDBAdapter, ICommandInterface>
        {
            ...
            public CommandProxy(IDBAdapter modelElement) : 
            ...
            /// </summary>
            public override ICommandInterface Value
            {
                get
                {
        ...
        /// </summary>
        private sealed class ConnectionProxy : ModelPropertyChange<IDBAdapter, IConnectionInterface>
        {
            ...
            /// </summary>
            /// <param name="modelElement">The model instance element for which to create the property access proxy</param>
            public ConnectionProxy(IDBAdapter modelElement) : 
            ...
            /// Gets or sets the value of this expression
            /// </summary>
            public override IConnectionInterface Value
            {
                get
                {
        ...
        /// <summary>
        /// Represents a proxy to represent an incremental access to the dataReader property
        /// </summary>
        private sealed class DataReaderProxy : ModelPropertyChange<IDBAdapter, IDataReaderInterface>
        {
            ...
            /// </summary>
            /// <param name="modelElement">The model instance element for which to create the property access proxy</param>
            public DataReaderProxy(IDBAdapter modelElement) : 
                    base(modelElement, "dataReader")
            {
            }
            ...
            /// Gets or sets the value of this expression
            /// </summary>
            public override IDataReaderInterface Value
            {
                get
                {
                    return this.ModelElement.DataReader;
                }
                set
                {
                    this.ModelElement.DataReader = value;
                }
            }
        }
