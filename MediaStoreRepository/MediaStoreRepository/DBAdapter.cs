...
namespace FZI.SoftwareEngineering.DeepModeling.Repository
{
    ...
    public class DBAdapter : MetaElement, IDBAdapter, IModelElement
    {
        ...
        public virtual ICommandInterface Command
        {
            get
            {
            ...
            set
            {
                if ((this._command != value))
                {
                    ...
                    this.OnCommandChanged(new ValueChangedEventArgs(old, value));
                }
            }
        }
        ...
        [XmlAttributeAttribute(true)]
        public virtual IConnectionInterface Connection
        {
            get
            {
            ...
            set
            {
                if ((this._connection != value))
                {
                    ...
                    this.OnConnectionChanged(new ValueChangedEventArgs(old, value));
                }
            }
        }
        ...
        [XmlAttributeAttribute(true)]
        public virtual IDataReaderInterface DataReader
        {
            get
            {
            ...
            set
            {
                if ((this._dataReader != value))
                {
                    ...
                    this.OnPropertyChanged("DataReader");
                    this.OnDataReaderChanged(new ValueChangedEventArgs(old, value));
                }
            }
        }
        ...
        public new static NMF.Models.Meta.IClass ClassInstance
        {
            get
            {
                return NMF.Models.Repository.MetaRepository.Instance.ResolveClass("http://github.com/georghinkel/mediaStore/Repository#//DBAdapter/");
            }
        }
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> CommandChanged;
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> DataReaderChanged;
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.CommandChanged;
            if ((handler != null))
            {
        ...
        private void OnResetCommand(object sender, EventArgs eventArgs)
        {
            this.Command = null;
        }
        ...
        /// <param name="sender">The object that sent this reset request</param>
        /// <param name="eventArgs">The event data for the reset event</param>
        private void OnResetConnection(object sender, EventArgs eventArgs)
        {
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.DataReaderChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        /// <param name="sender">The object that sent this reset request</param>
        /// <param name="eventArgs">The event data for the reset event</param>
        private void OnResetDataReader(object sender, EventArgs eventArgs)
        {
        ...
        {
            return ((IComponentType)(NMF.Models.Repository.MetaRepository.Instance.Resolve("http://github.com/georghinkel/mediaStore/Repository#//DBAdapter/")));
        }
        ...
        {
            return ((IClass)(NMF.Models.Repository.MetaRepository.Instance.Resolve("http://github.com/georghinkel/mediaStore/Repository#//DBAdapter/")));
        }
        
        /// <summary>
        /// The collection class to to represent the children of the DBAdapter class
        /// </summary>
        public class DBAdapterReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            {
                return Enumerable.Empty<IModelElement>().Concat(this._parent.Command).Concat(this._parent.Connection).Concat(this._parent.DataReader).Concat(this._parent.DeclaringType).Concat(this._parent.Opposite).GetEnumerator();
            }
        }
        ...
        private sealed class DataReaderProxy : ModelPropertyChange<IDBAdapter, IDataReaderInterface>
        {
            ...
            protected override void RegisterChangeEventHandler(System.EventHandler<NMF.Expressions.ValueChangedEventArgs> handler)
            {
                this.ModelElement.DataReaderChanged += handler;
            }
