...
namespace FZI.SoftwareEngineering.DeepModeling.Repository
{
    ...
    /// <summary>
    /// The default implementation of the OggEncoder class
    /// </summary>
    [XmlNamespaceAttribute("http://github.com/georghinkel/mediaStore/Repository")]
    [XmlNamespacePrefixAttribute("repo")]
    [ModelRepresentationClassAttribute("http://github.com/georghinkel/mediaStore/Repository#//OggEncoder")]
    [DebuggerDisplayAttribute("OggEncoder {Name}")]
    public partial class OggEncoder : NMF.Models.Meta.MetaElement, IOggEncoder, NMF.Models.IModelElement
    {
        ...
        public override IEnumerableExpression<NMF.Models.IModelElement> Children
        {
            get
            {
                return base.Children.Concat(new OggEncoderChildrenCollection(this));
            }
        }
        ...
        public new static IComponentType ComponentTypeInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((NMF.Models.Meta.IClass)(MetaRepository.Instance.Resolve("http://github.com/georghinkel/mediaStore/Repository#//OggEncoder")));
                }
        ...
        /// <summary>
        /// The collection class to to represent the children of the OggEncoder class
        /// </summary>
        public class OggEncoderChildrenCollection : ReferenceCollection, ICollectionExpression<NMF.Models.IModelElement>, ICollection<NMF.Models.IModelElement>
        {
            
            private OggEncoder _parent;
            
            /// <summary>
            /// Creates a new instance
            /// </summary>
            public OggEncoderChildrenCollection(OggEncoder parent)
            {
                this._parent = parent;
            }
