...
namespace FZI.SoftwareEngineering.DeepModeling.Repository
{
    ...
    public partial class EncodingAdapter : NMF.Models.Meta.MetaElement, IEncodingAdapter, NMF.Models.IModelElement
    {
        ...
        {
            return ((NMF.Models.Meta.ITypedElement)(((NMF.Models.ModelElement)(EncodingAdapter.ClassInstance)).Resolve("encoder")));
        }
        ...
        {
            return ((NMF.Models.Meta.ITypedElement)(((NMF.Models.ModelElement)(EncodingAdapter.ClassInstance)).Resolve("database")));
        }
        ...
        public class EncodingAdapterReferencedElementsCollection : ReferenceCollection, ICollectionExpression<NMF.Models.IModelElement>, ICollection<NMF.Models.IModelElement>
        {
            ...
            public override IEnumerator<NMF.Models.IModelElement> GetEnumerator()
            {
                return Enumerable.Empty<NMF.Models.IModelElement>().Concat(this._parent.Encoder).Concat(this._parent.Database).Concat(this._parent.DeclaringType).GetEnumerator();
            }
        }
