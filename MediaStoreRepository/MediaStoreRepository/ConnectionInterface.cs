...
namespace FZI.SoftwareEngineering.DeepModeling.Repository
{
    ...
    public partial class ConnectionInterface : NMF.Models.Meta.MetaElement, IConnectionInterface, NMF.Models.IModelElement
    {
        ...
        public new static IComponentType ComponentTypeInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((NMF.Models.Meta.IClass)(MetaRepository.Instance.Resolve("http://github.com/georghinkel/mediaStore/Repository#//ConnectionInterface")));
                }
