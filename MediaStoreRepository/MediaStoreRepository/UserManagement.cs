...
namespace FZI.SoftwareEngineering.DeepModeling.Repository
{
    ...
    public class UserManagement : MetaElement, IUserManagement, IModelElement
    {
        ...
        public virtual IUserDBInterface Database
        {
            get
            {
        ...
        public new static NMF.Models.Meta.IClass ClassInstance
        {
            get
            {
                return NMF.Models.Repository.MetaRepository.Instance.ResolveClass("http://github.com/georghinkel/mediaStore/Repository#//UserManagement/");
            }
        }
        ...
        {
            return ((IComponentType)(NMF.Models.Repository.MetaRepository.Instance.Resolve("http://github.com/georghinkel/mediaStore/Repository#//UserManagement/")));
        }
        ...
        {
            return ((IClass)(NMF.Models.Repository.MetaRepository.Instance.Resolve("http://github.com/georghinkel/mediaStore/Repository#//UserManagement/")));
        }
        
        /// <summary>
        /// The collection class to to represent the children of the UserManagement class
        /// </summary>
        public class UserManagementReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            {
                return Enumerable.Empty<IModelElement>().Concat(this._parent.Database).Concat(this._parent.DeclaringType).Concat(this._parent.Opposite).GetEnumerator();
            }
        }
