...
namespace FZI.SoftwareEngineering.DeepModeling.Repository
{
    ...
    /// <summary>
    /// The default implementation of the UserManagement class
    /// </summary>
    [XmlNamespaceAttribute("http://github.com/georghinkel/mediaStore/Repository")]
    [XmlNamespacePrefixAttribute("repo")]
    [ModelRepresentationClassAttribute("http://github.com/georghinkel/mediaStore/Repository#//UserManagement")]
    [DebuggerDisplayAttribute("UserManagement {Name}")]
    public partial class UserManagement : NMF.Models.Meta.MetaElement, IUserManagement, NMF.Models.IModelElement
    {
        ...
        public IUserDBInterface Database
        {
            get
            {
            ...
            set
            {
                ...
                {
                    IUserDBInterface old = this._database;
        ...
        public override IEnumerableExpression<NMF.Models.IModelElement> Children
        {
            get
            {
                return base.Children.Concat(new UserManagementChildrenCollection(this));
            }
        }
        ...
        public override IEnumerableExpression<NMF.Models.IModelElement> ReferencedElements
        {
            get
            {
                return base.ReferencedElements.Concat(new UserManagementReferencedElementsCollection(this));
            }
        }
        ...
        protected override void SetFeature(string feature, object value)
        {
            if ((feature == "DATABASE"))
            {
                this.Database = ((IUserDBInterface)(value));
                return;
            }
        ...
        /// <summary>
        /// The collection class to to represent the children of the UserManagement class
        /// </summary>
        public class UserManagementChildrenCollection : ReferenceCollection, ICollectionExpression<NMF.Models.IModelElement>, ICollection<NMF.Models.IModelElement>
        {
            ...
            /// </summary>
            public UserManagementChildrenCollection(UserManagement parent)
            {
                this._parent = parent;
            }
        ...
        /// The collection class to to represent the children of the UserManagement class
        /// </summary>
        public class UserManagementReferencedElementsCollection : ReferenceCollection, ICollectionExpression<NMF.Models.IModelElement>, ICollection<NMF.Models.IModelElement>
        {
            ...
            /// Creates a new instance
            /// </summary>
            public UserManagementReferencedElementsCollection(UserManagement parent)
            {
                this._parent = parent;
            }
        ...
        /// </summary>
        private sealed class DatabaseProxy : ModelPropertyChange<IUserManagement, IUserDBInterface>
        {
            ...
            public DatabaseProxy(IUserManagement modelElement) : 
            ...
            /// </summary>
            public override IUserDBInterface Value
            {
                get
                {
