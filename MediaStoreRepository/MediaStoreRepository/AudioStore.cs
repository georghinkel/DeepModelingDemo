...
namespace FZI.SoftwareEngineering.DeepModeling.Repository
{
    ...
    public partial class AudioStore : NMF.Models.Meta.MetaElement, IAudioStore, NMF.Models.IModelElement
    {
        ...
        {
            return ((NMF.Models.Meta.ITypedElement)(((NMF.Models.ModelElement)(FZI.SoftwareEngineering.DeepModeling.Repository.AudioStore.ClassInstance)).Resolve("audioDB")));
        }
        ...
        {
            return ((NMF.Models.Meta.ITypedElement)(((NMF.Models.ModelElement)(FZI.SoftwareEngineering.DeepModeling.Repository.AudioStore.ClassInstance)).Resolve("userManagement")));
        }
        ...
        public class AudioStoreReferencedElementsCollection : ReferenceCollection, ICollectionExpression<NMF.Models.IModelElement>, ICollection<NMF.Models.IModelElement>
        {
            ...
            public override IEnumerator<NMF.Models.IModelElement> GetEnumerator()
            {
                return Enumerable.Empty<NMF.Models.IModelElement>().Concat(this._parent.AudioDB).Concat(this._parent.UserManagement).Concat(this._parent.DeclaringType).Concat(this._parent.Opposite).Concat(this._parent.Anchor).GetEnumerator();
            }
        }
